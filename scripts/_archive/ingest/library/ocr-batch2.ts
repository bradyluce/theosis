...
// OCR scanned PDFs from the 2nd acquisition batch.
...
const JOBS: Job[] = [
  { slug: "aimilianos-on-prayer", sourcePdf: join(LIBRARY_DIR, "aimilianos-on-prayer", "source.pdf") },
  { slug: "cyril-alexandria-unity-of-christ", sourcePdf: join(LIBRARY_DIR, "cyril-alexandria-unity-of-christ", "source.pdf") },
  { slug: "zizioulas-being-as-communion", sourcePdf: join(LIBRARY_DIR, "zizioulas-being-as-communion", "source.pdf") },
  { slug: "moschos-spiritual-meadow", sourcePdf: join(LIBRARY_DIR, "moschos-spiritual-meadow", "source.pdf") },
  { slug: "cabasilas-life-in-christ", sourcePdf: join(LIBRARY_DIR, "cabasilas-life-in-christ", "source.pdf") },
  { slug: "paisius-little-russian-philokalia", sourcePdf: join(LIBRARY_DIR, "paisius-little-russian-philokalia", "source.pdf") },
];
