...
import { resolveFastLabel } from "@/lib/fasting";
import {
  colors,
  elevation,
  fonts,
...
// `resolveFastLabel` now lives in @/lib/fasting (imported above) so the
// notification scheduler shares the exact same wording.
